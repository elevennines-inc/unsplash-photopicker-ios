Pod::Spec.new do |spec|
  ...
  spec.homepage         = 'https://github.com/elevennines-inc/unsplash-photopicker-ios'
  spec.authors          = { 'Unsplash' => 'apps@unsplash.com' }
  spec.summary          = 'A photo picker to search for and use photos from Unsplash.'
  spec.source           = { :git => 'https://github.com/elevennines-inc/unsplash-photopicker-ios.git', :tag => '1.2.0' }
